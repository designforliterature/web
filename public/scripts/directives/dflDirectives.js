...
horaceApp.directive("uiMcomboChoices", function ($document) {
    // simultaneously should not be two open items
    var openElement = null, close;
    return {
        restrict: 'A',
        replace: true,
        template: '<span class="mcombo-container mcombo-container-multi" style="width: 300px;">' +
            ...
            '            <input type="text" autocomplete="off" ng-model="_search">' +
            '        </li>' +
            '    </ul>' +
            '    <span class="mcombo-drop">' +
            '        <ul class="choices">' +
