...
exports.use = function (app, cb) {
    ...
    var generalUtils = require('../utilities/generalUtils.js'),
        nodeUtils = require('util'); // nodejs utils
    ...
    try {
        ...
        app.use(function (error, req, res, next) {
            ...
            res.render('./500.hjs',
                {
                    title: '500',
                    error: generalUtils.sanitizeObject(nodeUtils.inspect(error)) + '  Url: ' + req.url
                }
            );
        ...
        cb(new generalUtils.DFLCondition(generalUtils.DFLCondition.fatal, 'Routes not created: ' + err, err));
    }
