...
var workService = {
    ...
    noteTypes: [ // TODO get from db
        {name: 'Comment', code: 'comment', descr: 'A simple comment on the selected text'},
        {name: 'Translation', code: 'translation', descr: 'A translation of the selected text'},
        {name: 'Paraphrase', code: 'paraphrase', descr: 'A paraphrase of the selected text'},
        {name: 'Syntax', code: 'syntax', descr: 'A note on the syntax of the selected text'},
        {name: 'Meaning', code: 'meaning', descr: 'The meaning or semantics of the selected text'}
    ],
